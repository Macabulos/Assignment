    ...
    <form id="save_voter" class="form-horizontal" method="POST" action="save_schedule.php" onsubmit="return validateForm()">    
        ...
        <div class="thumbnail_new_voter">
            ...
            <div class="radio_day">
                <input type="checkbox" value="Monday" name="Monday" id="Monday">
                <br>
                <input type="checkbox" value="Tuesday" name="Tuesday" id="Tuesday">
                <br>
                <input type="checkbox" value="Wednesday" name="Wednesday" id="Wednesday">
                <br>
                <input type="checkbox" value="Thursday" name="Thursday" id="Thursday">
                <br>
                <input type="checkbox" value="Friday" name="Friday" id="Friday">
                <br>
                <input type="checkbox" value="Saturday" name="Saturday" id="Saturday">
                <br>
        ...
        <select name="time_start" class="span3333" id="time_start" required>
            ...
            <?php $time_query=mysqli_query($conn,"select * from time_start")or die(mysqli_error($conn));
        ...
        <select name="time_end" id="time_end" class="span3333" required>
            <option value="">--Select--</option>
            <?php $time_end_query=mysqli_query($conn,"select * from time_end order by time_end_id ASC")or die(mysqli_error($conn));
    ...
    <?php } ?>
        ...
        <select name="subject" class="span333" id="subject" required>
            <option value="">--Select--</option>
        <?php $subject_query=mysqli_query($conn,"select * from subject")or die(mysqli_error($conn));
        ...
        <select name="teacher" class="span333" id="teacher" required>
            <option value="">--Select--</option>
            <?php $teacher_query=mysqli_query($conn,"select * from teacher")or die(mysqli_error($conn));
        ...
        <select name="room" class="span3333" id="room" required>
            <option value="">--Select--</option>
            <?php $room_query=mysqli_query($conn,"select * from room")or die(mysqli_error($conn));
    ...
    function validateForm() {
        // Check if at least one checkbox is selected for the days
        var dayChecked = false;
        var days = document.getElementsByName("Monday");
        var dayElements = document.getElementsByClassName('radio_day');
        var checkboxes = dayElements[0].getElementsByTagName('input');
